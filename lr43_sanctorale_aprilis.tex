...
\ifcsname preamble@file\endcsname
  \setcounter{page}{\getpagerefnumber{M-lr43_sanctorale_aprilis}}
\fi
...
\feast{P2F4}{In Solemnitate Sancti Joseph\\Sponsi Beatæ Mariæ Virginis\\Confessoris et Ecclesiæ universalis Patroni}
	...
	{}
\nocturn{1}
\gscore{P2F4N1R1}{R}{1}{Clamavit populus}
\gscore{P2F4N1R2}{R}{2}{Fecit me Dominus}
\gscore{P2F4N1R3}{R}{3}{Jam laetus moriar}
\nocturn{2}
\gscore{0501N2R2}{R}{4}{Dedisti mihi}
\gscore{P2F4N2R2}{R}{5}{Statuet filios suos sub tegmine}
\gscore{P2F4N2R3}{R}{6}{Si consistant}
\nocturn{3}
\gscore{P2F4N3R1}{R}{7}{Joseph fili David}
\gscore{P2F4N3R2}{R}{8}{Surge et accipe!\vvrub Ut adimpleretur}

\rubric{Infra Octavam et in die Octava, Responsoria in \Rnum{1} Nocturno de Tempore, in \Rnum{2} et \Rnum{3} Nocturnis ut in Festo.}
