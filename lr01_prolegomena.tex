...
\ifcsname preamble@file\endcsname
  \setcounter{page}{\getpagerefnumber{M-lr01_prolegomena}}
\fi
...
%%%%%%%%%%% TODO a place should be given to this rubric

\rubric{Quoties Lectiones \Rnum{1} Nocturni Dominicæ reponuntur infra Hebdomadam juxta Rubricas, dicuntur cum suis Responsoriis hic assignatis, omissis aliis secus recitandis, etiam si cum Lectionibus infra Hebdomadam positis conjugantur.}
