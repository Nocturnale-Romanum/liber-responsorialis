...
\nocturn{1}
\thispagestyle{empty}
\gscore{6GN1R1}{R}{1}{Dixit Dominus ad Noe}
\gscore{6GN1R2}{R}{2}{Noe vir justus}
\gscore{6GN1R3}{R}{3}{Quadraginta dies}
\pagebreak
\vspace*{-\baselineskip}
\nocturn{2}
\vspace{-0.5\baselineskip}
\gscore{6GN2R1}{R}{4}{Aedificavit Noe}
\gscore{6GN2R2}{R}{5}{Ponam arcum meum}
\gscore{6GN2R3}{R}{6}{Per memetipsum juravi}
\sixlinesvspace
\pagebreak
\nocturn{3}
\gscore{6GN3R1}{R}{7}{Benedixit Deus Noe}
\gscore{6GN3R2}{R}{8}{Ecce ego statuam}
\gscore{6GN3R3}{R}{9}{Cum turba plurima}
\sixlinesvspace
\pagebreak
...
\feast{5GF1}{Dominica in Quinquagesima}
	...
	{Semiduplex II. classis}{II. classis}{Quinquagesima}
	{Si Lectiones \Rnum{1} Nocturni transferuntur, Responsoria \Rnum{1} Nocturni transferuntur.}
	{Lectiones et Responsoria numquam transferuntur.}
\nocturn{1}
\thispagestyle{empty}
