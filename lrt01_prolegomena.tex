...
In particular, their effect may carry over the end of the staff into the next, if the same word is sung, and so long as a bar line is not used in the melisma.
...
%%I would note that these are the choral rubrics; in Tres abhinc annos, changes were made to private recitation. While people can do what they want, I think that insisting on the 1962 rubrics, with absolutions and blessings before and concluding Tu autem after the readings is good; plus, you were allowed to cut down the remaining feasts of IX lessons to one nocturne, and THAT is not restricted to private recitation; it seemingly includes choral prayer)
