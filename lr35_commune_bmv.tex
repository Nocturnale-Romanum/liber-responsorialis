...
\nocturn{1}
\gscore{CBMVN1R1}{R}{1}{Sancta et immaculata!\emph{cum} Alleluia}
\gscore{CBMVN1R2}{R}{2}{Congratulamini...parvula}
\gscore{CBMVN1R3}{R}{3}{Beata es Maria!\emph{cum} Alleluia}
\nocturn{2}
\gscore{CBMVN2R1}{R}{4}{Sicut cedrus}
\gscore{CBMVN2R2}{R}{5}{Quae est ista quae processit}
\gscore{CBMVN2R3}{R}{6}{Ornatam in monilibus}
\nocturn{3}
\gscore{CBMVN3R1}{R}{7}{Felix namque es!\vvrub Quia ex te}
\vspace{-0.25in}
\begin{tabbing}
...
\gscore{OPBMR1}{R}{1}{Missus est!\vvrub Dabit ei}
\gscore{A1N2R1}{R}{2}{Ave Maria}
\gscore{OPBMR3}{R}{3}{Suscipe verbum!\vvrub Paries}
